...
\begin{center}
\leavevmode
\includegraphics[width=177pt]{read_file_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
using \hyperlink{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}{vec} = vector$<$ string $>$
\item 
using \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} = vector$<$ \hyperlink{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}{vec} $>$
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \hyperlink{read_file_8h_a4d05aa34d631728e8dabfe1d9ddbdd69}{file\+To\+Matrix} (const string \&filename)
\item 
void \hyperlink{read_file_8h_ae04ba1e32f1dfd605e53f54c39b365fd}{display\+Matrix} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat)
\item 
bool \hyperlink{read_file_8h_a71844c343db9878de02bcddae45947dd}{username\+Matches\+Password} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&username, const string \&password)
\item 
void \hyperlink{read_file_8h_a3c27433c2ddbe1b8010a05a86cd21734}{average\+Grade\+Destination} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&destination)
\item 
bool \hyperlink{read_file_8h_ab6bce9fa2a7660f6f3ddcef5a4f7b906}{is\+Existing} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&check, int col)
\item 
int \hyperlink{read_file_8h_a331b6af63862d2ae3ad6abf71b0de381}{row\+Of\+Username} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&username)
\item 
int \hyperlink{read_file_8h_a4fc77629ec6e6556b5dc4dd8efa6f36c}{number\+Of\+Rows\+In\+File} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat)
\item 
void \hyperlink{read_file_8h_ac9d4f6924d2d252073454cbe2dfd9895}{display\+Friends} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&username)
\item 
bool \hyperlink{read_file_8h_a6b426552d2ff56784a167e799da87688}{is\+Already\+Friend} (const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&mat, const string \&friend\+To\+Be\+Added, const string \&username)
\item 
...
\index{read\+File.\+h@{read\+File.\+h}!matrix@{matrix}}
\index{matrix@{matrix}!read\+File.\+h@{read\+File.\+h}}
\subsubsection{\texorpdfstring{matrix}{matrix}}
{\footnotesize\ttfamily using \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} =  vector$<$\hyperlink{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}{vec}$>$}

\mbox{\Hypertarget{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}\label{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}} 
\index{read\+File.\+h@{read\+File.\+h}!vec@{vec}}
\index{vec@{vec}!read\+File.\+h@{read\+File.\+h}}
\subsubsection{\texorpdfstring{vec}{vec}}
{\footnotesize\ttfamily using \hyperlink{read_file_8h_ac4ba865c2f8f6f90e3c64552279f3d21}{vec} =  vector$<$string$>$}
...
{\footnotesize\ttfamily void average\+Grade\+Destination (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{destination }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_a3c27433c2ddbe1b8010a05a86cd21734_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily void display\+Friends (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{username }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_ac9d4f6924d2d252073454cbe2dfd9895_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_af9f2aec2ef105eff0f596a9b91ae98b3_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_a3c8596d363a098e38a811efab756aa5b_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily void display\+Matrix (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_ae04ba1e32f1dfd605e53f54c39b365fd_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} file\+To\+Matrix (\begin{DoxyParamCaption}\item[{const string \&}]{filename }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool is\+Already\+Friend (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{friend\+To\+Be\+Added,  }\item[{const string \&}]{username }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool is\+Existing (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{check,  }\item[{int}]{col }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily int number\+Of\+Rows\+In\+File (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily int row\+Of\+Username (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{username }\end{DoxyParamCaption})}
...
\index{read\+File.\+h@{read\+File.\+h}!username\+Matches\+Password@{username\+Matches\+Password}}
\index{username\+Matches\+Password@{username\+Matches\+Password}!read\+File.\+h@{read\+File.\+h}}
\subsubsection{\texorpdfstring{username\+Matches\+Password()}{usernameMatchesPassword()}}
{\footnotesize\ttfamily bool username\+Matches\+Password (\begin{DoxyParamCaption}\item[{const \hyperlink{read_file_8h_a869e2a5deeb3daa4c82d6bc91cf20d92}{matrix} \&}]{mat,  }\item[{const string \&}]{username,  }\item[{const string \&}]{password }\end{DoxyParamCaption})}

Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read_file_8h_a71844c343db9878de02bcddae45947dd_icgraph}
\end{center}
\end{figure}
